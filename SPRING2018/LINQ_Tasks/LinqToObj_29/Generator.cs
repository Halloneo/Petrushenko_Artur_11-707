...
namespace LinqToObj_29
{
    ...
    public class Generator
    {
        ...
        public static void Generate()
        {
            ...
            using (StreamWriter sw = new StreamWriter($"{directory}\\LinqToObj_29.txt"))
            {
                for (int j = 0; j < 144; j++)
                {
        ...
        public static List<Inhabitant> GetInhabitants()
        {
            ...
            using (StreamReader sr = new StreamReader($"{directory}\\LinqToObj_29.txt"))
