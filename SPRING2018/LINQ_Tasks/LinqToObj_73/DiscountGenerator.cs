...
namespace LinqToObj_73
{
    ...
    class DiscountGenerator
    {
        ...
        public static void Generate(int size)
        {
            ...
            using (StreamWriter sw = new StreamWriter($"{directory}\\LinqToObj_73_Discounts.txt"))
            {
        ...
        public static List<Discount> GetDiscounts(int size)
        {
            ...
            using (StreamReader sr = new StreamReader($"{directory}\\LinqToObj_73_Discounts.txt"))
