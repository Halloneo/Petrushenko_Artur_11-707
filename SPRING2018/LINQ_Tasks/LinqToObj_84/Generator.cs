...
namespace LinqToObj_84
{
    ...
    public class Generator
    {
        ...
        public static void Generate(int size)
        {
            ...
            using (StreamWriter sw = new StreamWriter($"{directory}\\LinqToObj_84D.txt"))
            {
            ...
            using (StreamWriter sw = new StreamWriter($"{directory}\\LinqToObj_84E.txt"))
            {
                for (int j = 0; j < size; j++)
                {
        ...
        public static List<Product> GetProducts(int size)
        {
            ...
            using (StreamReader sr = new StreamReader($"{directory}\\LinqToObj_84D.txt"))
        ...
        public static List<Purchases> GetPurchases(int size)
        {
            ...
            using (StreamReader sr = new StreamReader($"{directory}\\LinqToObj_84E.txt"))
                while (!sr.EndOfStream)
                    list.Add(sr.ReadLine());
